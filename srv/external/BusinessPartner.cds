/* checksum : 16bc5341aee89cb8d3fc0c7d801616d8 */
@cds.external : true
...
entity BusinessPartner.A_BPCreditWorthiness {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BPDataController {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BPEmployment {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BPFinancialServicesExtn {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BPFinancialServicesReporting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BPFiscalYearInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BPIntlAddressVersion {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BPRelationship {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity BusinessPartner.A_BPTaxCompliance {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BusinessPartner {
  ...
  @sap.quickinfo : 'Company ID of Trading Partner'
  TradingPartner : String(6);
  to_BPCreditWorthiness : Association to BusinessPartner.A_BPCreditWorthiness {  };
  to_BPDataController : Association to many BusinessPartner.A_BPDataController {  };
  to_BPEmployment : Association to many BusinessPartner.A_BPEmployment {  };
  to_BPFinServicesReporting : Association to BusinessPartner.A_BPFinancialServicesReporting {  };
  to_BPFiscalYearInformation : Association to many BusinessPartner.A_BPFiscalYearInformation {  };
  to_BPRelationship : Association to many BusinessPartner.A_BPRelationship {  };
  to_BPTaxCompliance : Association to many BusinessPartner.A_BPTaxCompliance {  };
  ...
  to_BusinessPartner : Association to BusinessPartner.A_BPFinancialServicesExtn {  };
  to_BusinessPartnerAddress : Association to many BusinessPartner.A_BusinessPartnerAddress {  };
  to_BusinessPartnerAlias : Association to many BusinessPartner.A_BusinessPartnerAlias {  };
  ...
  to_BusinessPartnerIsBank : Association to BusinessPartner.A_BusinessPartnerIsBank {  };
  to_BusinessPartnerRating : Association to many BusinessPartner.A_BusinessPartnerRating {  };
  ...
  to_PaymentCard : Association to many BusinessPartner.A_BusinessPartnerPaymentCard {  };
...
entity BusinessPartner.A_BusinessPartnerAddress {
  ...
  to_BPIntlAddressVersion : Association to many BusinessPartner.A_BPIntlAddressVersion {  };
  to_EmailAddress : Association to many BusinessPartner.A_AddressEmailAddress {  };
  to_FaxNumber : Association to many BusinessPartner.A_AddressFaxNumber {  };
  to_MobilePhoneNumber : Association to many BusinessPartner.A_AddressPhoneNumber {  };
  to_PhoneNumber : Association to many BusinessPartner.A_AddressPhoneNumber {  };
...
entity BusinessPartner.A_BusinessPartnerAlias {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BusinessPartnerIsBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartner.A_BusinessPartnerPaymentCard {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Ratings'
entity BusinessPartner.A_BusinessPartnerRating {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
