/* checksum : 20792ad5ed97483d9094ed6a07cde9e7 */
@cds.external : true
...
entity SalesOrder.A_SalesOrder {
  ...
  to_BillingPlan : Association to SalesOrder.A_SalesOrderBillingPlan {  };
  to_Item : Association to many SalesOrder.A_SalesOrderItem {  };
  to_Partner : Association to many SalesOrder.A_SalesOrderHeaderPartner {  };
  to_PaymentPlanItemDetails : Association to many SalesOrder.A_SlsOrdPaymentPlanItemDetails {  };
  to_PrecedingProcFlowDoc : Association to many SalesOrder.A_SalesOrderPrecdgProcFlow {  };
  to_PricingElement : Association to many SalesOrder.A_SalesOrderHeaderPrElement {  };
  to_RelatedObject : Association to many SalesOrder.A_SalesOrderRelatedObject {  };
  to_SubsequentProcFlowDoc : Association to many SalesOrder.A_SalesOrderSubsqntProcFlow {  };
  to_Text : Association to many SalesOrder.A_SalesOrderText {  };
};
...
entity SalesOrder.A_SalesOrderBillingPlan {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  to_BillingPlanItem : Association to many SalesOrder.A_SalesOrderBillingPlanItem {  };
  to_SalesOrder : Association to SalesOrder.A_SalesOrder {  };
};
...
entity SalesOrder.A_SalesOrderBillingPlanItem {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
entity SalesOrder.A_SalesOrderHeaderPartner {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  to_Address : Association to many SalesOrder.A_SalesOrderPartnerAddress {  };
  to_SalesOrder : Association to SalesOrder.A_SalesOrder {  };
};
...
entity SalesOrder.A_SalesOrderHeaderPrElement {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
entity SalesOrder.A_SalesOrderItem {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  to_BillingPlan : Association to SalesOrder.A_SalesOrderItemBillingPlan {  };
  to_Partner : Association to many SalesOrder.A_SalesOrderItemPartner {  };
  to_PrecedingProcFlowDocItem : Association to many SalesOrder.A_SalesOrderItmPrecdgProcFlow {  };
  to_PricingElement : Association to many SalesOrder.A_SalesOrderItemPrElement {  };
  to_RelatedObject : Association to many SalesOrder.A_SalesOrderItemRelatedObject {  };
  to_SalesOrder : Association to SalesOrder.A_SalesOrder {  };
  to_ScheduleLine : Association to many SalesOrder.A_SalesOrderScheduleLine {  };
  to_SubsequentProcFlowDocItem : Association to many SalesOrder.A_SalesOrderItmSubsqntProcFlow {  };
  to_Text : Association to many SalesOrder.A_SalesOrderItemText {  };
};
...
entity SalesOrder.A_SalesOrderItemBillingPlan {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  @sap.updatable : 'false'
  BillingPlanSearchTerm : String(10);
  to_BillingPlanItem : Association to many SalesOrder.A_SlsOrderItemBillingPlanItem {  };
  to_SalesOrder : Association to SalesOrder.A_SalesOrder {  };
  to_SalesOrderItem : Association to SalesOrder.A_SalesOrderItem {  };
};
...
entity SalesOrder.A_SalesOrderItemPartner {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  @sap.quickinfo : 'VAT Registration Number'
  VATRegistration : String(20);
  to_Address : Association to many SalesOrder.A_SalesOrderItemPartnerAddress {  };
  to_SalesOrder : Association to SalesOrder.A_SalesOrder {  };
  to_SalesOrderItem : Association to SalesOrder.A_SalesOrderItem {  };
};
...
entity SalesOrder.A_SalesOrderItemPartnerAddress {
  @sap.display.format : 'UpperCase'
  ...
  to_Partner : Association to SalesOrder.A_SalesOrderItemPartner {  };
  to_SalesOrder : Association to SalesOrder.A_SalesOrder {  };
  to_SalesOrderItem : Association to SalesOrder.A_SalesOrderItem {  };
};
...
entity SalesOrder.A_SalesOrderItemPrElement {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
entity SalesOrder.A_SalesOrderItemRelatedObject {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
@sap.content.version : '1'
@sap.label : 'Item Text'
entity SalesOrder.A_SalesOrderItemText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
entity SalesOrder.A_SalesOrderItmPrecdgProcFlow {
  @sap.display.format : 'UpperCase'
...
entity SalesOrder.A_SalesOrderItmSubsqntProcFlow {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Preceding Document'
  @sap.quickinfo : 'Preceding sales and distribution document'
  key SalesOrder : String(10) not null;
...
entity SalesOrder.A_SalesOrderPartnerAddress {
  @sap.display.format : 'UpperCase'
  @sap.label : 'SD Document'
  @sap.quickinfo : 'Sales and Distribution Document Number'
  key SalesOrder : String(10) not null;
  ...
  @sap.quickinfo : 'Fax no.: Extension'
  FaxExtensionNumber : String(10);
  to_Partner : Association to SalesOrder.A_SalesOrderHeaderPartner {  };
  to_SalesOrder : Association to SalesOrder.A_SalesOrder {  };
};
...
entity SalesOrder.A_SalesOrderPrecdgProcFlow {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Subsequent Document'
  @sap.quickinfo : 'Subsequent Sales and Distribution Document'
  key SalesOrder : String(10) not null;
...
entity SalesOrder.A_SalesOrderRelatedObject {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
entity SalesOrder.A_SalesOrderScheduleLine {
  @sap.display.format : 'UpperCase'
...
entity SalesOrder.A_SalesOrderSubsqntProcFlow {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Preceding Document'
  @sap.quickinfo : 'Preceding sales and distribution document'
  key SalesOrder : String(10) not null;
...
entity SalesOrder.A_SalesOrderText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
entity SalesOrder.A_SlsOrderItemBillingPlanItem {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
entity SalesOrder.A_SlsOrdPaymentPlanItemDetails {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Sales Order'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
@cds.external : true
type SalesOrder.FunctionResult {
  @sap.label : 'Indicator'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
...
@cds.external : true
action SalesOrder.rejectApprovalRequest(
  SalesOrder : String(11000)
) returns SalesOrder.FunctionResult;

@cds.external : true
action SalesOrder.releaseApprovalRequest(
  SalesOrder : String(11000)
) returns SalesOrder.FunctionResult;
